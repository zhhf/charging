...
#from charging.api.v2 import attributes
from charging.common import utils
from charging.openstack.common.db.sqlalchemy import session as db_session
from charging.openstack.common import log as logging
from charging.openstack.common import rpc
from charging.version import version_info as charging_version
...
rpc.set_defaults(control_exchange='charging')
...
def parse(args):
    cfg.CONF(args=args, project='charging',
             version='%%prog %s' % charging_version.release_string())
