...
from charging.api.views import versions as versions_view
...
class Versions(object):
    ...
    def __call__(self, req):
        ...
        LOG.debug('zhf.builder=%s,versions=%s,response=%s' % (builder,versions,response))
        metadata = {
            "application/xml": {
                "attributes": {
                    "version": ["status", "id"],
        ...
        LOG.debug('zhf.content_type=%s' % content_type)
